...
MAX_CONCURRENT = 3 # Lowered concurrency to avoid immediate blocks
...
async def run_fix():
    ...
    async with async_playwright() as p:
        ...
        print(f"Needs deep search via DDG/Google: {len(tasks)} books")
