...
async def main():
    async with async_playwright() as p:
        ...
        print("Visiting Fuse Literary Fantasy Books page...")
        await page.goto('https://www.fuseliterary.com/our-books/?_book_genre=fantasy', wait_until='domcontentloaded', timeout=60000)
        ...
        print(f"Extracted {len(unique_books)} unique fantasy books.")
