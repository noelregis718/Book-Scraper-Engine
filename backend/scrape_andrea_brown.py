    ...
    async with semaphore:
        ...
        try:
            ...
            if data:
                ...
                # We can also update synopsis if it's missing or if we want the GoodReads one
                current_synopsis = str(df.at[idx, 'Synopsis (if available)']).strip()
                if current_synopsis.lower() == 'nan' or current_synopsis == '':
...
async def run_scrape():
    ...
    async with async_playwright() as p:
        ...
        for idx in range(len(df)):
            ...
            # Make sure we have a title or an author
            if (title and title.lower() != 'nan') or (author and author.lower() != 'nan'):
