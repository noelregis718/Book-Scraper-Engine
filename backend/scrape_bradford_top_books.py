...
EXCEL_FILE = r"E:\Internship\PocketFM\Bradford_Literary_Formatted.xlsx"
MAX_CONCURRENT = 5
...
async def process_new_book(context, scraper, title, author, agent, semaphore):
    async with semaphore:
        ...
        row_data = {
            ...
            "Author Name": author,
            "Publisher": "Bradford Literary Agency",
...
async def run_scrape():
    ...
    async with async_playwright() as p:
        ...
        print("--- Finding the top 1 book for each author to add if missing ---")
        ...
        for author in authors:
            ...
            if author_books_to_scrape:
                ...
                print(f"  All top 1 books for {safe_author} are already in the sheet!")
