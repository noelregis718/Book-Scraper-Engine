...
async def process_author(author, context, semaphore):
...
async def run_scrape():
    ...
    # Actually, we should just scrape all of them since this is a new sheet and the user requested it for "these author names"
    ...
    async with async_playwright() as p:
        ...
        tasks = [process_author(author, context, semaphore) for author in all_authors]
