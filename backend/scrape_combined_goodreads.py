...
async def scrape_combined(excel_path, book_limit=5):
...
if __name__ == "__main__":
    ...
    excel_path = os.path.join(base, "combined_romance_titles_11_column_format.xlsx")
    asyncio.run(scrape_combined(excel_path, book_limit=50))
