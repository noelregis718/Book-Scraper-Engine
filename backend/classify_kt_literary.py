...
def classify_kt_literary(file_path):
    ...
    for idx, row in df.iterrows():
        ...
        # Don't overwrite if it's already perfectly mapped (except to standardize it)
        # We use the existing logic which combines existing + synopsis
...
if __name__ == "__main__":
    ...
    classify_kt_literary(file_path)
