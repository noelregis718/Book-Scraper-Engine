...
async def run():
    async with async_playwright() as p:
        ...
        await page.goto('https://harlequin.com/collections/harlequin-romance?meta.hc-product-mf.onSaleDateTimestamp=Current%20and%20previous%20months&sort=meta.hc-product-mf.onSaleDateTimestamp/DESC&page=1')
        ...
        dump_path = os.path.join(os.path.dirname(os.path.abspath(__file__)), "harlequin_dump.html")
