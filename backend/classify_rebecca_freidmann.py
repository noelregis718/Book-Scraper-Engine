...
KEYWORD_MAP = [
    ...
    ("High Fantasy Court Adventure", ["court", "throne", "kingdom", "royalty", "fae court", "high fantasy", "crown", "empire", "queen", "king", "prince", "realm", "dragon", "epic fantasy", "war", "political intrigue", "magic system", "fey", "fae"])
]
...
def main():
    ...
    for idx, row in df.iterrows():
        ...
        if title.lower() == 'nan' or title == 'N/A' or not title:
            continue
