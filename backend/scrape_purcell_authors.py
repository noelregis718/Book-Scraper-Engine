...
AUTHORS_TO_SCRAPE = [
    # Adult Fiction
    "Cara Sue Achterberg", "Elle Baade", "Sherrill Bodine", "Sarahlyn Bruck",
    "Cynthia Cain", "Ashlyn Cramer", "Pam Curtis", "Renee James", "Amy Klco",
    "Lynn Langan", "Marion McNabb", "K.E. Mullane", "Ryan Parsons", "James Pinard",
    "Michael Popke", "John Powers", "Danny Quinlan", "Brea Ruddy", "Jason Tanamor",
    "Sheri Taylor-Emery", "Vicki Volden", "Audrey Wilson",
    # Young Adult
    "Angelique Burrell", "M.E. Corey", "K.D. Gennaro", "Chad Harper",
    "Crystal A. Hill", "Ann Miller", "Kim Oclon"
]
    ...
    async with semaphore:
        ...
        try:
            ...
            for res in results:
                ...
                res["Publisher"] = "The Purcell Agency"
                res["Romantasy = Yes or No?"] = ""
                res["Romantasy Sub-Genre of series"] = ""
                res["Name of agent"] = "Tina P. Schwartz"  # Principal agent
                books.append(res)
...
async def run_scrape():
    ...
    # We only want to scrape the authors for which we don't already have multiple rows
    existing_authors = []
