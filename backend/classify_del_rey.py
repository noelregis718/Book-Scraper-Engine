...
def main():
    ...
    for idx, row in df.iterrows():
        ...
        # Based on user instruction: "most of the books over there are romantasy books only"
        # We set Romantasy = Yes for all of them and map the subgenre. If no subgenre found, 
        # default to High Fantasy Court Adventure or Paranormal Romance, let's use High Fantasy Court Adventure
