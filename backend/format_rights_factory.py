...
def apply_11_column_format(input_file, output_file):
    ...
    # Assuming 'Title' maps to 'Name of Series'
...
if __name__ == '__main__':
    input_path = os.path.join(os.path.dirname(os.path.dirname(os.path.abspath(__file__))), "the_rights_factory_books_complete.xlsx")
    output_path = os.path.join(os.path.dirname(os.path.dirname(os.path.abspath(__file__))), "the_rights_factory_books_formatted.xlsx")
