...
async def scrape_handspun_aggressive(excel_path):
    ...
    semaphore = asyncio.Semaphore(15) # Boosted concurrency to 15 for aggressive scraping
    ...
    async with async_playwright() as p:
        ...
        print("Login done. Starting aggressive scrape for Handspun books...\n")
        ...
        for index, row in df.iterrows():
            ...
            # Only scrape if link is N/A or empty
...
if __name__ == "__main__":
    ...
    target = os.path.join(base, "Handspun_Literary_Formatted.xlsx")
    asyncio.run(scrape_handspun_aggressive(target))
