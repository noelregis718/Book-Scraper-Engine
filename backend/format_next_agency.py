...
# 1. Read and fix the columns
df = pd.read_excel(file_path)
df['Name of Series'] = df['Name of agent in the main folder']
df['Name of agent in the main folder'] = ""
df.to_excel(file_path, index=False)

# 2. Apply premium JRA styling
...
wb.save(file_path)
print("Data updated and premium styling applied to Next_Agency.xlsx successfully.")
