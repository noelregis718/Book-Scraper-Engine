...
def main():
    ...
    for idx, row in df.iterrows():
        ...
        # Combine all text to classify subgenre, including existing genre column from scraping
        combined_text = synopsis + " " + title + " " + current_sub
        ...
        if current_yes_no.lower() == 'yes' or subgenre_result is not None:
